                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="Formulario">
									<form data-toggle="validator" role="form" id="frm-alumno" action="?c=alumno&a=Guardar" method="post" >
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input class="form-control"  name="persona_cui" value="<?php echo $pvd->persona_cui; ?>"  placeholder="Ingrese CUI" pattern="^\d{8}$" data-error="CUI no valido" required>
											<div class="help-block with-errors"></div>
										</div>
                                ...
                                <div class="tab-pane fade" id="Archivo">
                                    <form data-toggle="validator" role="form" id="frm-alumno-archivo" enctype="multipart/form-data" action="?c=alumno&a=GuardarArchivo" method="post">
                                        
                                        <div class="form-group">
                                            <label for="archivo" class="control-label" >Subir Archivo</label>
